...
final class MessageMedia {
    ...
    public function convertIphoneImage(string $origem, string $destino): void {
        ...
        try {
            ...
            if (!$imagem->writeImage($destino)) {
                throw new InvalidArgumentException('Não foi possível converter a fotografia.');
            }
    ...
    public function receive(array $ficheiro, bool $audio = false): array {
        ...
        if ($erro !== UPLOAD_ERR_OK) {
            throw new InvalidArgumentException('O ficheiro não foi enviado completamente.');
        }
        ...
        if (!is_string($mime) || !isset($tipos[$mime])) {
            throw new InvalidArgumentException('Só podes enviar fotografias ou vídeos.');
        }
        ...
        if ($imagemIphone) {
            ...
            throw new InvalidArgumentException('Não foi possível guardar o ficheiro.');
        }

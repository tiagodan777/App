...
class Validate {
    ...
    public static function age(string $birthDate): ?int {
        ...
        $date = \DateTimeImmutable::createFromFormat('!Y-m-d', $birthDate, new \DateTimeZone('UTC'));

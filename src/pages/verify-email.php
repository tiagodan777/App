...
if (!preg_match('/^[a-f0-9]{64}$/', $token)) {
    ...
    $limite = consumirLimiteRequisicoes('verify-email-ip', chaveLimiteRequisicoes(enderecoCliente()), 30, 60 * 60);
    if (!$limite['permitido']) {
...
echo $twig->render('verify-email.html', ['verificado' => $verificado, 'mensagem_erro' => $mensagemErro]);

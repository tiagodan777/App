(function (window, document, $) {
    ...
    async function prepararTecladoNativo() {
         ...
         * Muito importante:
         *
         * NÃO alteramos o resize mode aqui.
         *
         * A aplicação inteira permanece em
         * resize:none para a WKWebView nunca
         * ficar presa à altura do teclado.
         */
